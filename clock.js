...
// Handle's origin border and clock border color.
const red = style.getPropertyValue("--cred");

// Handles and day light arc color.
const yellow = style.getPropertyValue("--cyellow");
...
drawClock.decimals.reverse();
drawClock.decimals[0].txt = "24";
drawClock.decimals[6].c = white2;
drawClock.decimals[18].c = white2;
...
var runAnimation = (() => {
  ...
  const clock_handles = [
    { width: 8, length: 0.5, c: yellow },
    { width: 8, length: 0.8, c: yellow },
    { width: 2, length: 0.9, c: yellow },
    { width: 1, length: 0.95, c: red },
  ];
